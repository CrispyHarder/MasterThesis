...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(CIFAR10("/gris/gris-f/homestud/mofuchs/MHDiversty/" + "CIFAR10", train=True, transform=Compose([RandomHorizontalFlip(), RandomCrop(32,4), ToTensor(), Normalize(mean=(0.4914, 0.4822, 0.4465), std=(0.2023, 0.1994, 0.2010))]),download=True), batch_size=128, shuffle=True)
