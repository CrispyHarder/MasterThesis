...
parser.add_argument('--commitment_cost', default=1.0, type=float,
                    help='the commitment cost from the paper')
...
def main():
    ...
    for nr_run in range(runs_start_at,runs_start_at + nr_runs):
        ...
        model = Model(args.embedding_dim, args.num_embeddings, 
